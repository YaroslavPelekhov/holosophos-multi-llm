...
---
Данный модуль содержит код для проведения контролируемых экспериментов, используемых при генерации и анализе научных статей по направлению **«обучение с подкреплением с использованием генеративных моделей мира»**.
